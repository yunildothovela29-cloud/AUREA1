...
export const BuyPage: React.FC = () => {
  ...
  const reset = () => {
    setFilters({ searchQuery: '', operation: 'venda', location: '', type: '', minPrice: '', maxPrice: '', bedrooms: '', sortBy: 'featured' });
    setSearchParams({});
  };
  ...
  return (
    <div className="pt-28 pb-20 bg-[#F7F9FC] min-h-screen">
      <section className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="mb-6">
          <span className="text-xs uppercase tracking-[0.18em] text-[#D93030] font-bold">Venda</span>
          <h1 className="text-3xl sm:text-4xl font-semibold text-[#14245F] mt-2">Imóveis para comprar</h1>
          <p className="text-sm sm:text-base text-[#667085] mt-2 max-w-2xl">Casas e apartamentos disponíveis. Escolha uma propriedade para ver fotos, preço e localização.</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white border border-dashed border-[#C7CFDC] rounded-2xl py-16 px-5 text-center mt-7">
            ...
            <p className="text-sm text-[#667085] mt-2">Não encontramos imóveis para comprar com estes filtros.</p>
