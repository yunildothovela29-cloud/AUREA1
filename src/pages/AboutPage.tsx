...
export const AboutPage: React.FC = () => {
  ...
  return (
    <div className="pt-32 pb-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-32 text-[#261B14]">
      {/* 1. Header & Brand Story */}
      <section className="max-w-4xl">
        <span className="text-xs uppercase tracking-[0.25em] text-[#825A39] font-semibold block mb-4">
          História & Identidade
        </span>
        <h1 className="font-serif text-4xl sm:text-5xl lg:text-7xl text-[#221A15] font-normal tracking-tight leading-[1.15] mb-8">
          Nascemos da convicção de que cada casa é um manifesto de vida.
        </h1>
        <p className="text-lg sm:text-xl text-[#5E5249] leading-relaxed tracking-wide">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 relative">
          <div className="aspect-16/10 rounded-3xl overflow-hidden shadow-lg border border-[#E8E2D6]">
            <img
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="p-10 rounded-3xl bg-white border border-[#E8E2D6] shadow-sm space-y-6">
            <span className="text-[11px] uppercase tracking-[0.25em] text-[#825A39] font-semibold block">
              A Nossa Missão
            </span>
      ...
      <section className="bg-white rounded-3xl p-10 sm:p-16 lg:p-24 border border-[#E8E2D6] shadow-xs">
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-base text-[#5E5249] mt-4 tracking-wide">
            Actuamos em diferentes frentes com a mesma dedicação técnica e humana.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="p-8 rounded-2xl bg-[#FAF8F5] border border-[#E8E2D6] space-y-4">
            <div className="w-12 h-12 rounded-2xl bg-[#FAF4ED] border border-[#EFE5D8] text-[#825A39] flex items-center justify-center">
              <Building className="w-6 h-6" />
            </div>
            <h4 className="font-serif text-2xl font-normal text-[#221A15]">
              Aquisição Residencial
            </h4>
            <p className="text-sm text-[#6B5E54] leading-relaxed tracking-wide">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((v, i) => (
            <div
              key={i}
              className="p-8 rounded-2xl bg-white border border-[#E8E2D6] hover:border-[#825A39]/50 transition-colors shadow-sm"
            >
              <div className="w-10 h-10 rounded-2xl bg-[#FAF4ED] border border-[#EFE5D8] flex items-center justify-center text-[#825A39] mb-5">
                <CheckCircle2 className="w-5 h-5" />
              </div>
              <h4 className="font-serif text-xl font-normal text-[#221A15] mb-3">
                {v.title}
              </h4>
              <p className="text-sm text-[#6B5E54] leading-relaxed tracking-wide">
                {v.desc}
      ...
      <section className="bg-[#3E2819] text-[#FAF8F5] rounded-3xl p-12 sm:p-20 lg:p-24 shadow-xl relative overflow-hidden">
        <div className="max-w-2xl mb-16">
          <span className="text-xs uppercase tracking-[0.3em] text-[#D8BFA6] font-medium block mb-4">
            Metodologia
          </span>
          <h2 className="font-serif text-4xl sm:text-5xl text-[#FAF8F5] font-normal tracking-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {steps.map((s) => (
            <div key={s.num} className="space-y-4 relative">
              ...
              <h4 className="font-serif text-2xl text-[#FAF8F5] font-normal">
                {s.title}
              </h4>
      ...
      <section className="text-center max-w-2xl mx-auto space-y-8 pt-8">
        <h3 className="font-serif text-4xl text-[#221A15] font-normal tracking-tight">
          Deseja conhecer o nosso portfólio em detalhe?
        </h3>
        <p className="text-base text-[#5E5249] tracking-wide">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 pt-4">
          <Link
            to="/agendar"
            className="px-10 py-4 rounded-full bg-[#3E2819] text-[#FAF8F5] hover:bg-[#26180E] text-xs uppercase tracking-widest font-semibold transition-all shadow-md"
          >
            Agendar Visita
          </Link>
          <Link
            to="/contactos"
            className="px-10 py-4 rounded-full border border-[#D5C9B8] text-[#221A15] bg-white hover:bg-[#FAF5EE] text-xs uppercase tracking-widest font-semibold transition-colors"
          >
            Falar com a Equipa
          </Link>
        </div>
